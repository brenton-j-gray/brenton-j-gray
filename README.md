# Brenton Gray
**Software Engineer | Computer Science Fundamentals | Cloud & Gaming Infrastructure Curious**
...
- Clean APIs and modular architecture  
...
- Reliability, observability, and secure design principles  
...
- Multi-language experience across C++, Java, JavaScript, Node.js, and databases
- Readable, approachable code with an emphasis on correctness and edge cases
- End-to-end thinking in full-stack projects (UI, backend logic, and persistence)

Examples:
- **Credit Card Number Validator (C++)**  
  A clean implementation of the Luhn algorithm with input validation and card-type identification. This project intentionally emphasizes correctness, edge handling, and translating an algorithm into maintainable code.

- **Full‑Stack Projects (Movie Database, WasteNot, Tennis League)**  
  These demonstrate comfort with CRUD workflows, relational and non-relational data stores, basic API design, and real-world data constraints. I focused on making the systems functional and understandable before optimizing prematurely.

- **Portfolio Website**  
  A pragmatic project that uses the GitHub API to dynamically display repositories. It prioritizes function over flash and shows comfort working with external APIs and client-side logic.

### Gaps I’m Actively Aware Of
- Most projects are **educational or exploratory**, not production-hardened services
- Limited use of automated testing frameworks
...
- **LinkedIn:** https://www.linkedin.com/in/brenton-gray  
- **GitHub:** https://github.com/brenton-j-gray
